...
async def versicherter_speichern(
    ...
    return redirect(request, 
        f"/versicherte/?person={quote(felder['person_name'], 303)}&ok=1",
        status_code=303,
    )
...
async def ersatz_speichern(
    ...
    return redirect(request, 
        f"/versicherte/?person={quote(person, 303)}&ok=Ersatzpflegekraft+gespeichert",
        status_code=303,
    )
...
async def ersatz_loeschen(
    ...
    return redirect(request, 
        f"/versicherte/?person={quote(person, 303)}&ok=Ersatzpflegekraft+gelöscht",
        status_code=303,
    )
